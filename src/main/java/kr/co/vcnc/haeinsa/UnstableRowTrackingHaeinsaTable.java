 ...
 */
public class UnstableRowTrackingHaeinsaTable extends ForwardingHaeinsaTable {
  private static final Logger LOG = LoggerFactory.getLogger(UnstableRowTrackingHaeinsaTable.class);
  ...
  public UnstableRowTrackingHaeinsaTable(HaeinsaTableIface haeinsaTable, HTableInterface unstableRowsTable) {
    super(haeinsaTable);
