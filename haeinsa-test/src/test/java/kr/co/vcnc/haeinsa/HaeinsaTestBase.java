...
/**
 * Basic test class for Haeinsa unit tests. This class automatically create CLUSTER, and table name
 * of each test method. You can get context of the test with {@link #context()}.
 */
public class HaeinsaTestBase {
  ...
  /**
   * Context of current test. You can create {@link Table} and {@link HaeinsaTableIface} with this
   * class. You can also get instance of {@link Table} with {@link #getTransactionManager()}.
   */
  public static final class TestingContext {
    ...
    /**
     * Get {@link HaeinsaTestingCluster} instance for test. Since creating new testing cluster takes
     * long time, each test case reuse the cluster. For this reason, the testing cluster is managed
     * as singleton, so this method always returns same instance of {@link HaeinsaTestingCluster}.
     *
    ...
    /**
     * Create {@link HaeinsaTableIface} with table name. The name of the table will be created with
     * {@link #createContextedTableName(String)}.
     *
    ...
    /**
     * Create {@link Table} with table name. The name of the table will be created with {@link
     * #createContextedTableName(String)}.
     *
    ...
    /**
     * Create table name for current test method. This method create table name with class name and
     * method name of the test. Since, tests in Haeinsa reuse {@link HaeinsaTestingCluster}, data in
     * the cluster would affect to each test cases. To avoid this, each test should use it's own
     * table. This is why this method is needed.
     *
