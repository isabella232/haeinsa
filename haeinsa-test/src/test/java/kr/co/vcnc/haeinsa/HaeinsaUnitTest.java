 ...
 * conflict and recover test, conflict and abort test, HaeinsaWithoutTx test, and HBase migration
 * test.
 */
public class HaeinsaUnitTest extends HaeinsaTestBase {
  ...
  public void testTransaction() throws Exception {
    ...
    testPut.add(
        Bytes.toBytes("data"), Bytes.toBytes("phoneNumber"), Bytes.toBytes("010-9876-5432"));
    ...
    tx.rollback();
    Assert.assertEquals(
        result.getValue(Bytes.toBytes("data"), Bytes.toBytes("phoneNumber")),
        Bytes.toBytes("010-1234-5678"));
    Assert.assertEquals(
        result2.getValue(Bytes.toBytes("data"), Bytes.toBytes("phoneNumber")),
        Bytes.toBytes("010-9876-5432"));
    ...
    testPut.add(
        Bytes.toBytes("data"), Bytes.toBytes("phoneNumber"), Bytes.toBytes("010-1234-5678"));
    testTable.put(tx, testPut);
    tx.commit();
    ...
    Assert.assertEquals(
        logTable.get(tx, get).getValue(Bytes.toBytes("raw"), Bytes.toBytes("time-0")),
        Bytes.toBytes("log-value-1"));
    get = new HaeinsaGet(Bytes.toBytes("row-0"));
    get.addColumn(Bytes.toBytes("data"), Bytes.toBytes("time-0"));
    Assert.assertEquals(
        testTable.get(tx, get).getValue(Bytes.toBytes("data"), Bytes.toBytes("time-0")),
        Bytes.toBytes("data-value-1"));
    get = new HaeinsaGet(Bytes.toBytes("row-0"));
    get.addColumn(Bytes.toBytes("meta"), Bytes.toBytes("time-0"));
    Assert.assertEquals(
        testTable.get(tx, get).getValue(Bytes.toBytes("meta"), Bytes.toBytes("time-0")),
        Bytes.toBytes("meta-value-1"));
    tx.rollback();
  ...
  public void testMultiPutAndMultiDelete() throws Exception {
    ...
    Assert.assertTrue(
        Bytes.equals(
            result.getValue(Bytes.toBytes("data"), Bytes.toBytes("phoneNumber")),
            Bytes.toBytes("010-1234-5678+2")));
    Assert.assertNull(result.getValue(Bytes.toBytes("data"), Bytes.toBytes("name")));
    Assert.assertTrue(
        Bytes.equals(
            result.getValue(Bytes.toBytes("data"), Bytes.toBytes("city")), Bytes.toBytes("Seoul")));
    Assert.assertTrue(
        Bytes.equals(
            result.getValue(Bytes.toBytes("data"), Bytes.toBytes("email")),
            Bytes.toBytes("ymkim+1@vcnc.co.kr")));
    tx.rollback();
  ...
  public void testConflictAndRecover() throws Exception {
    ...
    try {
      ...
      Assert.assertNull(result2);
      Assert.assertEquals(
          result1.getValue(Bytes.toBytes("data"), Bytes.toBytes("phoneNumber")),
          Bytes.toBytes("010-9876-5432"));
  ...
  public void testMultipleMutations() throws Exception {
    ...
    Assert.assertEquals(
        testTable.get(tx, get).getValue(Bytes.toBytes("meta"), Bytes.toBytes("column-d")),
        Bytes.toBytes("value-d"));

    get = new HaeinsaGet(Bytes.toBytes("row-e"));
    get.addColumn(Bytes.toBytes("meta"), Bytes.toBytes("column-e"));
    Assert.assertEquals(
        testTable.get(tx, get).getValue(Bytes.toBytes("meta"), Bytes.toBytes("column-e")),
    ...
    Assert.assertEquals(
        testTable.get(tx, get).getValue(Bytes.toBytes("data"), Bytes.toBytes("col-after")),
  ...
  public void testDanglingRowLockException() throws Exception {
...

    {
      TRowKey primaryRowKey =
          new TRowKey().setTableName(testTable.getTableName()).setRow(Bytes.toBytes("James"));
      TRowKey danglingRowKey =
          new TRowKey().setTableName(testTable.getTableName()).setRow(Bytes.toBytes("Brad"));
      TRowLock danglingRowLock =
          new TRowLock(HaeinsaConstants.ROW_LOCK_VERSION, TRowLockState.PREWRITTEN, 1376526618707L)
      ...
      hPut.addColumn(
          HaeinsaConstants.LOCK_FAMILY,
          HaeinsaConstants.LOCK_QUALIFIER,
          danglingRowLock.getCurrentTimestamp(),
          TRowLocks.serialize(danglingRowLock));
      hTestTable.put(hPut);
    ...
    {
      TRowKey primaryRowKey =
          new TRowKey().setTableName(testTable.getTableName()).setRow(Bytes.toBytes("Andrew"));
      TRowLock primaryRowLock =
          new TRowLock(
              HaeinsaConstants.ROW_LOCK_VERSION, TRowLockState.STABLE, System.currentTimeMillis());
      TRowKey danglingRowKey =
          new TRowKey().setTableName(testTable.getTableName()).setRow(Bytes.toBytes("Alpaca"));
      TRowLock danglingRowLock =
          new TRowLock(HaeinsaConstants.ROW_LOCK_VERSION, TRowLockState.PREWRITTEN, 1376526618717L)
      ...
      hPut.addColumn(
          HaeinsaConstants.LOCK_FAMILY,
          HaeinsaConstants.LOCK_QUALIFIER,
          primaryRowLock.getCommitTimestamp(),
          TRowLocks.serialize(primaryRowLock));
      hTestTable.put(hPut);
  ...
  public void testScannerAfterDeletion(boolean reversed) throws Exception {
    ...
    try (HaeinsaTableIface testTable = context().getHaeinsaTableIface("test")) {
      ...
      tx = tm.begin();
      assertEquals(
          getList(testTable, tx, "b", "c", reversed),
          asList(reversed, b0, b1, b2),
          "data",
          "phoneNumber",
          null);
  ...
  public static void assertEquals(
      Collection<HaeinsaResult> actual,
      Collection<HaeinsaResult> expected,
      String family,
      String qualifier,
      String message) {
    if (actual != expected) {
      ...
      Assert.assertEquals(
          actual.size(), expected.size(), message + ": lists don't have the same size");
      ...
      while (actIt.hasNext() && expIt.hasNext()) {
        ...
        Assert.assertEquals(
            a.getValue(Bytes.toBytes(family), Bytes.toBytes(qualifier)),
            e.getValue(Bytes.toBytes(family), Bytes.toBytes(qualifier)),
            errorMessage);
      }
    }
  }
  ...
  private List<HaeinsaResult> getList(
      HaeinsaTableIface table, HaeinsaTransaction tx, String start, String stop, boolean reversed)
      throws IOException {
    byte[] startB = start.getBytes(StandardCharsets.UTF_8);
    byte[] stopB = stop.getBytes(StandardCharsets.UTF_8);

    try (HaeinsaResultScanner scanner =
        table.getScanner(
            tx,
            new HaeinsaScan()
  ...
  private void tablePut(
      HaeinsaTransaction tx,
      HaeinsaTableIface table,
      String id,
      String family,
      String qualifier,
      String value)
  ...
  private void htablePut(Table htable, String id, String family, String qualifier, String value)
      throws IOException {
  ...
  private void clearTable(HaeinsaTransactionManager tm, HaeinsaTableIface table)
      throws IOException {
    HaeinsaTransaction tx = tm.begin();
    HaeinsaScan scan = new HaeinsaScan();
