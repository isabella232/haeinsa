...
/**
 * Tracking parameters of {@link HaeinsaScan} and {@link HaeinsaIntraScan} inside {@link
 * HaeinsaTable}.
 *
...
public class HaeinsaColumnTracker {
   ...
   *
   * <ol>
   *   <li>If scan do not specify any column family - return true if kv is inside qualifier range.
   *   <li>If scan specify column families, but not any qualifiers. - return true when kv has same
   *       column family and is inside scan range.
   *   <li>If scan specify both column families and column qualifiers - return true only if kv
