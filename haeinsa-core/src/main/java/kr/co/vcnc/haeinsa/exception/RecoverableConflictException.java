...
/**
 * This exception will occur when transaction fails on making row state to stable. Since failure of
 * the operation can be recovered by next access, this exception can be ignored. This class extends
 * {@link ConflictException}, because this occurs on failure of write by other transaction.
 */
