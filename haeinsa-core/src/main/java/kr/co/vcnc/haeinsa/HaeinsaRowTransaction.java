...
/**
 * Contains Transaction information of single row. This information is only saved in client memory
 * until {@link HaeinsaTransaction#commit()} called.
 */
public class HaeinsaRowTransaction {
  ...
  /**
   * Return list of {@link HaeinsaKeyValueScanner}s which wrap mutations (Put and Delete) contained
   * inside instance. Also assign sequenceID to every MutationScanner of {@link HaeinsaMutation}.
   */
