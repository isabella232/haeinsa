...
/**
 * Custom integration of {@link ColumnRangeFilter} in Haeinsa. In contrast to {@link HaeinsaScan},
 * HaeinsaIntraScan can be used to retrieve range of column qualifier inside single row with
 * scan-like way.
 *
 * <p>User can specify column family, range of qualifier, size of batch at a time and whether start
 * column and last column are included.
 *
...
public class HaeinsaIntraScan extends HaeinsaQuery {
  ...
  public HaeinsaIntraScan(
      final byte[] row,
      final byte[] minColumn,
      boolean minColumnInclusive,
      final byte[] maxColumn,
