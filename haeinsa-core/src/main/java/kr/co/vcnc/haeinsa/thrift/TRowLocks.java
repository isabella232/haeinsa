...
/**
 * Static class for TRowLock (Thrift class) Provide static method to serialize/deserialize with
 * TCompactProtocol of Thrift
 *
...
public final class TRowLocks {
  ...
  public static boolean isSecondaryOf(
  ...
  public static boolean containsRowKeyAsPrimary(TRowLock secondaryRowLock, TRowKey primaryRowKey) {
    if (secondaryRowLock.isSetPrimary()) {
      return Arrays.equals(
              secondaryRowLock.getPrimary().getTableName(), primaryRowKey.getTableName())
