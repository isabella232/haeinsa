...
/**
 * HaeinsaScan is analogous to {@link Scan} class in HBase. HaeinsaScan can be used to retrieve
 * range of row with specific family or (family, qualifier) pairs.
 *
 * <p>HaeinsaScan do not support to set batch value, but only support caching. So if user only
 * specify column family and retrieve data from HBase, {@link HaeinsaResultScanner} will return
 * whole column family of the row at one time.
 */
...
public class HaeinsaScan extends HaeinsaQuery {
   ...
   *
   * <p>If row is not specified for HaeinsaScan, the Scanner will start from the beginning of the
   * table.
   */
  public HaeinsaScan() {}
   ...
   *
   * <p>If the specified row does not exist, the Scanner will start from the next closest row after
   * the specified row.
   *
   ...
   *
   * <p>Overrides previous calls to addColumn for this family.
   *
   ...
   *
   * <p>This is false by default which means forward(normal) scan.
   *
